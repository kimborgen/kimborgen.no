    ...
    return (
      <footer className='footer'>
        <div className='footer__links'>
            ...
            <a href='mailto:hi@kimborgen.com' className='fa fa-envelope' target='newtab' />
        ...
        <p className='footer__copyrigth'>&copy; Kim Borgen 2017 <i className='fa fa-long-arrow-right fa-lg infarrow' aria-hidden='true' /> <div className='footer__copyrigth__infinte'>&infin;</div></p>
      </footer>
    )
  }
}
