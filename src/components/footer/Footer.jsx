  ...
  render () {
    return (
      <footer className='footer'>
          ...
          <p className='footer__copyrigth'>&copy; Kim Borgen 2017 <i className='fa fa-long-arrow-right fa-lg' aria-hidden='true' /> <div className='footer__copyrigth__infinte'>&infin;</div></p>
        </footer>
    )
  }
}
