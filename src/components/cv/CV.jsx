  ...
  render () {
    ...
    return (
      <div className='wrapper__cv'>
        ...
        { this.props.location.pathname.toLowerCase() === '/cv' || this.props.location.pathname.toLowerCase() === '/businesscv' ? undefined : <div className="cvlinks">Click for printable CV's: <Link to='/cv'>Standard Tech CV</Link><Link to='/businesscv'>Business CV</Link></div> }
