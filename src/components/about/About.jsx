  ...
  render () {
    ...
    return (
      <section className='about'>
        ...
        <article>
          <h2>Passion</h2>
          <p>I believe emerging technologies such as <b>blockchain</b> and <b>artificial intelligence</b> has the ability to revolutionize and <b>disrupt</b> the status quo. These technologies allows us to create new, <b>innovative</b> and <b>creative solutions</b> that will usher in a brand new globalized, automized and <b>decentralized</b> age.
          </p>
        </article>
      </section>
    )
